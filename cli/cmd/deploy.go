...
func init() {
	...
	deployCmd.PersistentFlags().StringVarP(&file, "file", "f", "", "path to config file")
	deployCmd.MarkFlagFilename("file")
	deployCmd.PersistentFlags().StringVarP(&configString, "string", "s", "", "json encoded string of config")
}
