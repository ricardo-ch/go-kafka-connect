...
// SetLogFormatter provides a mock function with given fields: formatter
func (_m *MockHighLevelClient) SetLogFormatter(formatter logrus.Formatter) {
	_m.Called(formatter)
}
...
// SetPauseBeforeDeploy provides a mock function with given fields: pauseBeforeDeploy
func (_m *MockHighLevelClient) SetPauseBeforeDeploy(pauseBeforeDeploy bool) {
	_m.Called(pauseBeforeDeploy)
}
...
type mockConstructorTestingTNewMockHighLevelClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockHighLevelClient(t mockConstructorTestingTNewMockHighLevelClient) *MockHighLevelClient {
